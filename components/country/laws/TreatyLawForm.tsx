...
interface ITreatyLawForm {
  country: number;
  setCountry: (countryId: number) => void;
}

// TODO: Filter out countries that aren't at war with user's country
export default function TreatyLawForm({ country, setCountry }: ITreatyLawForm) {
