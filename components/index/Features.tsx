...
export default function Features() {
  return (
    <Card>
      <Card.Header className='text-xl text-center font-bold mb-4 text-white h-brand'>Features</Card.Header>
      <Card.Content className='text-white'>
        <List spacing={3}>
          <ListItem>
            <p className='text-lg font-semibold text-accent'>Player-Ran Simulation</p>
          ...
          <ListItem>
            <p className='text-lg font-semibold text-accent'>In-Depth Mechanics</p>
          ...
          <ListItem>
            <p className='text-lg font-semibold text-accent'>Caters to all Gameplay Styles</p>
